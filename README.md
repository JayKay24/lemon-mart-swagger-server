# LemonMart OpenAPI Specification
[![Build Status](https://travis-ci.org/https://github.com/JayKay24/lemon-mart-swagger-server.git.svg?branch=master)](https://travis-ci.org/https://github.com/JayKay24/lemon-mart-swagger-server.git)
